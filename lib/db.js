...
const PATH_RESULT = PATH_ROOT + '/pretrain';
...
module.exports = {
    add_db_items, find_db_item, hurt_mark_db_item,
    get_priviate,
    get_sample,
    get_db,
    get_len_db,
...
function clear_cache_db() {
    ...
    deleteFolderRecursive(PATH_PREPROCESS_VIDEO);
    deleteFolderRecursive(PATH_POSTPROCESS_VIDEO);
}
